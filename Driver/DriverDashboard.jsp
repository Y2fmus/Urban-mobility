...
<body>
    <% 
        ...
        int Driverid = (Integer) request.getAttribute("Driverid");
    ...
    <div class="header">
        ...
        <div class="user-info">
            <h1>Welcome, <%= Drivername %>,<%= Driverid%></h1>
    ...
    <div class="layout">
        <div class="sidebar">
            ...
            <a href="Booking.jsp?Username=<%=Drivername%>&Userid=<%=Driverid%>"><i class="fas fa-taxi"></i> Book List</a>
